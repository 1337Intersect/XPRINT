...
Global $g_iSortColumn = -1 ; La colonna attualmente ordinata (-1 = nessuna)
Global $g_bSortAscending = True ; True = ascendente, False = discendente
...
;------------------------------------------------------
Func _guiCreate()
    $hGUI = GUICreate("XPRINT 1.14.2", 498, 285, Default, Default)
